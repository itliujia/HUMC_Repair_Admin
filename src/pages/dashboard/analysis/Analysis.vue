  ...
  <div class="analysis">
    <a-row style="margin-top: 0" :gutter="[24, 24]">
      <a-col :sm="24" :md="12" :xl="6">
        <chart-card :loading="loading" title="平台总人数" :total="total">
...
export default {
  ...
  mounted: {
    getNum() {
      this.$axios({
        method: "get",
        url: `http://116.62.33.39:14578/student`,
        params: { pageStart: 0, pageNum: 1 },
      }).then((response) => {
      ...
      // this.$axios({
      //   method: "get",
      //   url: `http://116.62.33.39:14578/teacher`,
      //   params: { pageStart: 0, pageNum: 1 },
      // }).then((response) => {
      //   var teacherNum = response.data.data.total;
      //   console.log(response.data);
      // });
      // this.$axios({
      //   method: "get",
      ...
      //   params: { pageStart: 0, pageNum: 1 },
      // }).then((response) => {
      //   var workerNum = response.data.data.total;
      //   console.log(response.data);
      // });

      // this.total=parseInt(studentNum)+parseInt(teacherNum)+parseInt(workerNum)
